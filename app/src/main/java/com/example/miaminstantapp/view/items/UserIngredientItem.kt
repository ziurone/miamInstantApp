...
class UserIngredientItem constructor(
    ...
    private val editIconClickListener: (ingredientId: Int) -> Unit
    ...
    override fun bind(viewHolder: UserIngredientItemViewHolder, position: Int) {
        ...
        viewHolder.editButton.setOnClickListener { editIconClickListener(userIngredient.ingredient.ingredientId) }
